...
//            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent=new Intent(HomeActivity.this,AllHostelsActivity.class);
            startActivity(intent);
        ...
        {
            Intent intent=new Intent(HomeActivity.this,ComplaintsActivity.class);
            startActivity(intent);
        ...
        {
            Intent intent=new Intent(HomeActivity.this, FilterRoomActivity.class);
            startActivity(intent);
