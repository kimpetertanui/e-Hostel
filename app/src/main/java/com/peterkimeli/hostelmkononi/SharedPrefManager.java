...
//        editor.putString(KEY_PHONENUMBER, user.getPhone_no());
//        editor.putString(KEY_EMAIL, user.getEmail());
//        editor.putString(KEY_ID, user.getId_no());
