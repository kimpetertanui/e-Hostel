    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DashMenuActivity.this, UserLoginActivity.class);

                startActivity(intent);

                Toast.makeText(DashMenuActivity.this, "Log Out Successfully", Toast.LENGTH_LONG).show();
